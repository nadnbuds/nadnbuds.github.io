...
window.onload = function () {
    ...
    function pushStartInfo() {
        ...
        row.style.opacity = 0;
        row.innerHTML = "<p class='histHeader'>Start</p> <p class='histData'> Latitude: " + storage[i][0]
            + "</br> Longitutde: " + storage[i][1]
            + "</br> Time: " + storage[i][2] + "</p>";
        unfade(row);
    }
    ...
    function pushStopInfo() {
        ...
        if (table.innerHTML != "") {
            ...
            row.style.opacity = 0;
            row.innerHTML = "<p class='histHeader'>Stop</p> <p class='histData'> Latitude: " + storage[i][3]
                + "</br> Longitude: " + storage[i][4] + "</br> Time: " + storage[i][5] + "</br> Elapsed Time: "
                + storage[i][6] + "</p>";
            unfade(row);
            storeData();
        }
